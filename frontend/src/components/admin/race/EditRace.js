            ...
            <div className='mt-8'>
                ...
                <div className="relative z-0 w-full mb-6 group">
                    ...
                    <input
                        ...
                        className="block py-2.5 px-0 w-full text-sm text-white bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer mt-2"
                        placeholder=" "
                        required
                    />
                    <label
