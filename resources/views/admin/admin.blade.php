...
<html class="bg-slate-900">
    ...
    <body class="max-w-lg mx-auto mt-32">
        <div class="mx-auto max-w-sm p-6 bg-white rounded-lg shadow">
            ...
            <a href="{{ url('admin/dashboard') }}" type="button" class="text-white text-center text-sm rounded-lg block bg-gradient-to-r from-cyan-500 to-blue-500 w-full pl-10 p-2.5 mt-5">Entrar</a>
        </div>
    </body>
</html>
